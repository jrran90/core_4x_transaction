...
const envVarsSchema = Joi.object({
  ...
  USER_JWT_SECRET: Joi.string().required()
    .description('User JWT Secret required to sign'),
  ...
  AMQP_PROTOCOL: Joi.string().required()
    .description('AMQP Protocol is required'),
  AMQP_HOSTNAME: Joi.string().required()
  ...
  SKU_TRAP: Joi.string().required()
  .description('SKU_TRAP')
}).unknown()
  .required();
...
const config = {
  ...
  userJwtSecret: envVars.USER_JWT_SECRET,
  mongo: {
  ...
  amqp: {
    protocol: envVars.AMQP_PROTOCOL,
    hostname: envVars.AMQP_HOSTNAME,
    port: envVars.AMQP_PORT,
    username: envVars.AMQP_USERNAME,
    password: envVars.AMQP_PASSWORD
  },
  skuTrap: envVars.SKU_TRAP
};
